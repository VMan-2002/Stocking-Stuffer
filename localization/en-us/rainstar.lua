return {
    descriptions = {
        stocking_present = {
            Rainstar_stocking_instant_yuri = {
                name = 'Instant Yuri',
                text = {
            ...
            Rainstar_stocking_enchanted_coal = {
                name = 'Enchanted Coal',
                text = {
                    'Use this to {C:attention}Balance{} Chips & Mult',
                    'for one round',
        ...
        stocking_wrapped_present = {
            Rainstar_stocking_present = {
                name = '{V:1}Present',
                text = {
                    '{C:inactive}The contents of this present',
                    '{C:inactive}may be of interest to you.'
                }
            },
        }
    }
